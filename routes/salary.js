...
<td colspan="4">${netPay.toFixed(2)}</td>
    ...
    generatePDFWithWatermark(htmlContent, (err, buffer) => {
      if (err) {
          ...
          <body style="font-family: Arial, sans-serif; background-color: #f9f9f9; color: #555;">
          
              <div style="margin: 0 auto; max-width: 600px; padding: 20px; background-color: #fff; border: 1px solid #ddd;">
                  <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                          <td align="center">
                              <img src="https://www.datagateway.in/assets/data-gateway.png" alt="Company Logo" style="max-width: 50%; height: auto;">
                          </td>
                      </tr>
                      <tr>
                          <td align="center" style="padding: 20px 0;">
                              <h2 style="margin: 0; font-size: 24px;">Hello, ${employeeName} Your Salary Slip is ready!</h2>
                          </td>
                      </tr>
                      <tr>
                          <td>
                              <p> You got one attachment of salary slip for the current month</p>
                              <p>Have a good day!</p>
              ...
              <div style="margin: 0 auto; max-width: 600px; padding: 20px; text-align: center;">
                  ...
                  <p style="font-size: 12px; color: #575757;">  <p>This mail was sent to you because your mail is enrolled as an employee at Datagateway,</p>
                  Office No. 301/2, Corporate Plaza, Senapati Bapat Road, Near Chaturshrunghi temple, Maharashtra, Pune - 411016</p>
              </div>
  ...
  `          
    ...
    const emailSubject = 'Salary Slip';


sendEmail([email], emailSubject, emailContent, `salary_slip_${employeeName}.pdf`, buffer)
  .then(() => {
...
async function sendEmail(to, subject, htmlContent, attachmentFilename, pdfBuffer) {
  try {
